        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header" data-background-color="blue">
                    <div class="row">
                        <div class="col-md-6">
                            <h5 class="title">AHIJADO : ( <strong> {{ $godchildren->first_name }} {{ $godchildren->last_name }} ) </strong> </h5>
                        </div>
                        <div class="col-md-4">
                            <h5 class="title center-block"> LISTA DE SUS PADRINOS</h5>
                        </div>
                    </div>
                </div>
                <div class="card-content table-responsive">
                    <table class="table" id="example">
                        ...
                        @foreach ($godfathers as $godfather)
                            <tr >
                                <td>{{ Carbon\Carbon::parse($godfather->date_membership)->toFormattedDateString() }}</td>
